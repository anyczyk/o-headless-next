<?php
if ( ! function_exists( 'render_slider_carousel_dynamic_v1' ) ) {
    function render_slider_carousel_dynamic_v1( $attributes ) {
        ...
        if ( $query->have_posts() ) {
            ?>
                <div class="wp-block-semdesign-d-002-slider-carousel-dynamic-v1-wrap swiper-module">
                    <div class="container">
                        <div class="wp-block-semdesign-d-002-slider-carousel-dynamic-v1 swiper-carousel-dynamic swiper-container" data-pagination-clickable="true" data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
                            <div class="swiper-wrapper">
                                ...
                                while ( $query->have_posts() ) {
                                    ...
                                    <div class="swiper-slide">
                                        <?php if ( $image_url ) : ?>
                                            <img class="wp-block-semdesign-d-002-slider-carousel-dynamic-v1__image" loading="lazy" src="<?php echo esc_url( $image_url ); ?>" alt="<?php the_title_attribute(); ?>" />
                                        <?php endif; ?>
                                        <div class="swiper-slide__container">
                                            <div>
                                                <<?= $tagName ?> class="h3"><?php the_title(); ?></<?= $tagName ?>>
                                                <?php
...
add_action( 'init', function () {
    ...
    if ( $registry->is_registered( 'semdesign/d-002-slider-carousel-dynamic-v1' ) ) {
        $registry->unregister( 'semdesign/d-002-slider-carousel-dynamic-v1' );
    }
    register_block_type( 'semdesign/d-002-slider-carousel-dynamic-v1', [
        'render_callback' => 'render_slider_carousel_dynamic_v1',
    ] );
} );
